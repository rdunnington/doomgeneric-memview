...
pub fn memview_msg_stack(stack_id: c_ulonglong, string_buffer: [*]const u8, string_length: c_uint) callconv(.C) void {
    if (c_context) |context| {
...
pub fn memview_msg_free(address: c_ulonglong) callconv(.C) void {
    if (c_context) |context| {
